...
describe('export uploads', () => {
  it('should be able to export uploads', async () => {
    // Mockando a função uploadFileToStorage
    ...
    const sut = await exportUploads({
      // Exportar cada arquivo para fazer os uploads
      searchQuery: namePattern,
    })

    const generatedCSVStream = uploadStub.mock.calls[0][0].contentStream // Pegando o stream gerado pelo csv-stringify

    // Convertendo o stream em string
    ...
    // Convertendo o csv em array para fazer as comparações do retorno esperado
